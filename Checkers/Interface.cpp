...
bool Interface::isHovered(const sf::RenderWindow& window, const sf::RectangleShape& button) {
...
void Interface::SetPointer(sf::RenderWindow& window, sf::RectangleShape& pointer, const bool hideMouse) {
...
bool Interface::isClicked(const sf::RenderWindow& window, const sf::RectangleShape& button) {
...
bool Interface::isMouseInWindow(const sf::RenderWindow& window) {
